...
?>
            <div class="content">
                <div class="container">
                    ...
                    $columns = 'admin_name';
                    $condition = "admin_email = '$admin_email'"; // Add single quotes around $admin_email
                    $limit = 1;
                    $orderBy = "";
                    $name = extractData($db, $tableName, $columns, $condition, $limit, $orderBy);
                    ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number">Welcome</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="olive fas fa-user-shield"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="violet fas fa-baseball-ball"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle"></p>
                                                <span class="number">Total odds</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
